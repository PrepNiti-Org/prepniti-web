                ...
                <div className="space-y-8 relative z-10 max-w-lg my-auto">
                    <div className="space-y-4">
                        ...
                        <p className="text-base text-muted-foreground leading-relaxed">
                            Start your competitive exam preparation today. PrepNiti provides secure progress tracking, anonymous mock exams, and collaborative benchmark analytics.
                        </p>
                    </div>
                ...
                >
                    <div className="flex flex-col space-y-2 text-center lg:text-left">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Enter your details below to set up your prep space.
                        </p>
                    </div>
