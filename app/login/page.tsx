                ...
                <div className="space-y-8 relative z-10 max-w-lg my-auto">
                    <div className="space-y-4">
                        ...
                        <p className="text-base text-muted-foreground leading-relaxed">
                            PrepNiti is an anonymous, high-performance community built for competitive exam aspirants. Track study logs, practice full-length mocks, and benchmark your progress without compromising identity.
                        </p>
                    </div>
