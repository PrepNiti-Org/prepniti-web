...
import TrackerDashboard from "@/app/tracker/page";
import { Button } from "@/components/ui/button";
import { ArrowRight, Lock, Layers, ShieldCheck, BarChart3 } from "lucide-react";
...
export function HomeContent() {
    ...
    return isLoggedIn ? <TrackerDashboard /> : <GuestLanding />;
}
